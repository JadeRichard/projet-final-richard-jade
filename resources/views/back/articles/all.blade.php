...
@include('back.partials.navbar')
    ...
    <div style="margin: auto; width: 90%;">
        ...
        <a href="{{ route('articles.create') }}" class="btn btncus mb-5" style="background-color: #A12C2F; color: white;">Create</a>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"> 
                            <div class='d-flex justify-content-center'>
                                ...
                                <a class='btn btncus3 mx-2' style="background-color: #A12C2F; color: white;" href='{{ route('articles.show', $item->id) }}' article='button'>Read</a>

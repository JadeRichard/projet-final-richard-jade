            ...
            <div class="fullwidthbanner">
                <ul>
                    <li class="first-slide" data-transition="fade" data-slotamount="10" data-masterspeed="300">
                        <img src="{{ asset("images/banner/banner-1.png") }}" data-fullwidthcentering="on" alt="slide">
                    ...
                    <li class="first-slide" data-transition="fade" data-slotamount="10" data-masterspeed="300">
                        <img src="{{ asset("images/banner/banner-2.png") }}" data-fullwidthcentering="on" alt="slide">
